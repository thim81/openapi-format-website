    ...
    <div className="container max-w-6xl">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
        ...
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
            Format, sort, filter &amp; transform your OpenAPI specs. Keep your API definitions clean and consistent.
          </p>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {documentationLinks.map((d) => (
                  <li key={d.href}>
                    <Link to={d.href} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                      {d.label}
                    </Link>
                  </li>
                ))}
      ...
      <div className="border-t pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
        <p>
          ...
          <a href="https://trinixlabs.dev" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground">
            TrinixLabs
          </a>
        </p>
        <div className="flex items-center gap-4">
          <a href="https://github.com/thim81/openapi-format" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
            <Github className="h-4 w-4" />
          </a>
          <a href="https://www.npmjs.com/package/openapi-format" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
            npm
          </a>
        </div>
      </div>
