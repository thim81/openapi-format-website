  ...
  return (
    <section className="py-20 md:py-32">
      <div className="container flex flex-col items-center text-center gap-6 max-w-3xl">
        ...
        >
          A CLI and library to sort, filter, and format OpenAPI specs — making them
          consistent, clean, and diff-friendly.
        </motion.p>
        ...
        >
          ...
          <button onClick={copy} className="ml-2 text-muted-foreground hover:text-foreground transition-colors" aria-label="Copy">
        ...
        >
          <a href="https://github.com/thim81/openapi-format" target="_blank" rel="noopener noreferrer">
            <Button size="lg">
