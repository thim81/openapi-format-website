    ...
    items: [
      {
        ...
        keywords: 'install setup npm yarn npx global local',
      },
      {
        label: 'CLI Options',
        href: '/docs/cli-options',
        keywords: 'command line flags arguments output',
      },
      {
        label: 'Configuration File',
        href: '/docs/configuration',
        keywords: 'config yaml json settings options file',
      },
    ],
  },
  {
    ...
    items: [
      {
        label: 'Sorting',
        href: '/docs/sorting',
        keywords: 'sort order alphabetical properties paths',
      },
      {
        label: 'Filtering',
        href: '/docs/filtering',
        keywords: 'filter remove exclude include tags operations',
      },
      {
        label: 'Formatting & Casing',
        href: '/docs/formatting',
        keywords: 'format case camel snake kebab naming',
      },
      {
        label: 'Overlays',
        href: '/docs/overlays',
        keywords: 'overlay merge extend override patch',
      },
      { label: 'Generate', href: '/docs/generate', keywords: 'generate create output produce' },
      {
        label: 'Split & Bundle',
        href: '/docs/split-bundle',
        keywords: 'split bundle multi file components refs',
      },
      {
        label: 'Convert',
        href: '/docs/convert',
        keywords: 'convert transform swagger openapi yaml json',
      },
      {
        label: 'Rename',
        href: '/docs/rename',
        keywords: 'rename replace title description operationId',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        keywords: 'api programmatic javascript typescript code import',
      },
    ],
  },
];
  ...
  return (
    <div className='min-h-screen bg-background text-foreground overflow-x-hidden'>
      ...
      <div className='container flex'>
        {/* Desktop sidebar */}
        <aside className='hidden lg:block w-64 shrink-0 border-r py-8 pr-6'>{sidebar}</aside>
            ...
            <nav className='mt-12 flex items-stretch gap-4 border-t pt-6'>
              {prev ? (
                ...
                >
                  ...
                  <span className='mt-1 text-sm font-medium group-hover:text-foreground'>
                    {prev.label}
                  </span>
                </Link>
              ) : (
