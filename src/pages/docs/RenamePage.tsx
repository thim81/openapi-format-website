...
const RenamePage = () => (
  <DocsLayout>
    ...
    <p className='text-muted-foreground mb-4'>
      Change the title of your OpenAPI document — useful in CI/CD pipelines to create distinct
      output variants.
    </p>
    ...
    <CodeBlock
      code={`npx openapi-format openapi.json -o openapi.json --rename "OpenAPI Petstore - OpenAPI 3.0"`}
      title='Terminal'
    />
