...
const FormattingPage = () => (
  <DocsLayout>
    ...
    <CodeBlock
      code={`npx openapi-format openapi.json -o output.json --casingFile customCasing.yaml`}
      title='Terminal'
    />
