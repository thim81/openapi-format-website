...
const ConfigurationPage = () => (
  <DocsLayout>
    ...
    <CodeBlock
      code={`npx openapi-format openapi.json --configFile openapi-format-options.json`}
      title='Terminal'
    />
  ...
  "generateFile": "generate-rules.json"
    ...
    <div className='overflow-x-auto mb-8'>
      <table className='w-full text-sm border-collapse'>
        ...
        <tbody className='text-muted-foreground'>
          <tr className='border-b'>
            <td className='py-2 pr-4 font-mono text-xs text-foreground'>sortSet</td>
            <td className='py-2 pr-4 font-mono text-xs text-foreground'>sortFile</td>
            <td className='py-2'>Custom field ordering rules</td>
          </tr>
          <tr className='border-b'>
            <td className='py-2 pr-4 font-mono text-xs text-foreground'>casingSet</td>
            <td className='py-2 pr-4 font-mono text-xs text-foreground'>casingFile</td>
            <td className='py-2'>Casing conventions for elements</td>
          </tr>
          <tr className='border-b'>
            <td className='py-2 pr-4 font-mono text-xs text-foreground'>filterSet</td>
            <td className='py-2 pr-4 font-mono text-xs text-foreground'>filterFile</td>
            <td className='py-2'>Filter rules for stripping items</td>
          </tr>
          <tr className='border-b'>
            <td className='py-2 pr-4 font-mono text-xs text-foreground'>generateSet</td>
            <td className='py-2 pr-4 font-mono text-xs text-foreground'>generateFile</td>
            <td className='py-2'>Auto-generation templates</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <p className='mb-4 text-muted-foreground'>
      openapi-format automatically loads a{' '}
      <code className='rounded bg-muted px-1.5 py-0.5 font-mono text-sm'>.openapiformatrc</code>{' '}
      file from the current directory. CLI options override these settings.
    </p>
    <CodeBlock
      code={`{
